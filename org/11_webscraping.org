...
- The ~select~ function uses CSS selectors to match elements, like
  classes, IDs etc. It returns a list of elements matching the
  selector:
  #+begin_src python
    ...
    elements = soup.select('.container .text') # 'text' in 'container'
    for element in elements:
        print(f'container text: {element.text}')  

    elements = soup.select('.text') # elements named 'text'
    for element in elements:

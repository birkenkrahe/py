...
- Check out R for free: DataCamp or Matloff's "fasteR" (2023).
- From novice to expert: write 36,500 lines of code per year.
- AI coding assistants: use them carefully and only irregularly.
- check out a visual coding language: Snap! (snap.berkeley.edu)

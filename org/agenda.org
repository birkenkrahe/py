...
** TODO Review and preview (test 2 is coming soon)
...
5) When is the message "Get ready to host" below printed if the
   ...
   #+end_quote
6) What type of data does a ~while~ conditions evaluate to?
   #+begin_quote
...
** TODO Finish ~range~, then: module ~import~, sample program
** TODO In-class summary
#+attr_latex: :width 300px
#+caption: Women spectators at wrestling, Sydney stadium 1940 (Flickr.com)
[[../img/summary.jpg]]
...
* TODO Day 21
* TODO Day 22
* TODO Day 23: Project presentations
* TODO Day 24: Project presentations / Summary / Outlook
* Footnotes

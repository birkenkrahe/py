...
* TODO Day 24: 3 project presentations/summary/outlook
#+attr_latex: :width 400px
...
- Mostly missing bits: *what we didn't get into*
  1) text mining applications, natural language programming
...
- Matthews (2023). Python Crash Course (3e). NoStarch.
- Tuckfield (2021). Dive into Algorithms. NoStarch.
- Vasiliev (2022). Python for Data Science. NoStarch.

...
8) ~array~ is a function in ~numpy~. How do we call it?
   ...
   #+RESULTS:
   : [1 2 3]
9) What is another name for a function in Python?
   #+begin_quote
   A method.
   #+end_quote
10) Which command opens up the documentation for ~len~?
    #+begin_quote
...
1) What is the output when you run this code? (Source: [[https://twitter.com/driscollis/status/1665702110950993920?s=20][Twitter]].)
   #+begin_src python
     number = 8

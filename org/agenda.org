...
7) What's the difference between a compiled language (for example C)
   vs. an interpreted language (for example for Python or R)?
   #+begin_quote
...
** TODO In-class summary - what did we discuss today?
#+attr_html: :width 400px
#+caption: Women spectators at wrestling, Sydney stadium 1940 (Flickr.com)
[[../img/summary.jpg]]

** NEXT Homework: first assignment
...
* Day 3: Expressions, Variables, Statements
* Day 4
* Day 5
* Day 6
* Day 7 

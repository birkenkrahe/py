...
* NEXT Day 12: Global scope/exception handling/lists
#+attr_latex: :width 400px
#+caption: Llyfrgell Genedlaethol Cymru / Llanfachraeth in darkness (1957)
[[../img/lists.jpg]]

* TODO A bit traumatized by this image (as a German)
#+attr_latex: :width 400px
...
5) If a function does not have a return statement, what is the return
...
* TODO Day 13: References/Game of Life
#+attr_latex: :width 400px
...
1) How can you force a variable in a function to refer to the global
   variable?
   #+begin_quote
...
2) What is the output when you run this code? (Source: [[https://twitter.com/driscollis/status/1665702110950993920?s=20][Twitter]].)
   #+begin_src python
     number = 8
...
* TODO Day 14: Dictionaries/Zen of Python
#+attr_latex: :width 400px

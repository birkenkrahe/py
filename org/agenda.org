...
** DONE The caret ~^~ operator in Python
...
- What do you get when you type ~ord?~ on the Python console (~>>>~)?
  #+begin_quote
  A ~SyntaxError~ because ~?~ is an IPython shell command only.
  #+end_quote

- What does the dot-operator do, e.g. in ~str.split~?
  #+begin_quote
...
- How can you get 3 as a number from the keyboard and store it as an
...
** TODO [[https://lyon.instructure.com/courses/1700/assignments][I shelved the 3rd DataCamp assignment!]]

INFORMAL OPEN TOOL POLL:
- Have you used the *DataCamp workspace* at this point?
- Have you used the *REPL in replit.com* at all?
- Have you used *Python's IDLE* outside of class?
- Have you opened a *Python shell* ~>>>~ outside of class?
- Are you satisfied with Colab as your only tool?
- In case you want to try Emacs, talk to me.

** TODO Preview and review

- What is a 'Pythonista'? Are you one?
  #+begin_quote
...
- What's the difference between ~n=1~ and ~n==1~?
  #+begin_quote
...
- How can you turn a Unicode point into a character and vice versa?
  #+begin_src python
    # Courtesy Radek
    print(chr(120))
    print(ord('x'))
...
- How can you check if a variable ~x~ is an integer, float or string?
  #+begin_src python
    x = 42.0
...
- How can you check if a value is in a list or not?
  #+begin_src python
    print('a' in ['a','b'])
    print('a' not in ['a','b'])
    print('a' in ['b','c'])
...
#+attr_latex: :width 400px
#+caption: Perier family in de Dion voiturette, c.1903 (Flickr.com)
[[../img/import.jpg]]

** TODO Test 2 is coming: with Python Lists (DataCamp)

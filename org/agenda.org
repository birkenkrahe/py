...
** TODO Project time! No class on Monday 12-June, 19-June!
#+attr_latex: :width 400px
...
1) Jonathan: Hexagonal grid game built with PyGame
2) Radek: Scrape and analyze journal data with ...?
3) 
4) 
5) 
6) 

** TODO Test 3 is coming - includes Numpy (DataCamp)
** TODO In-class summary
#+attr_latex: :width 300px
#+caption: Women spectators at wrestling, Sydney stadium 1940 (Flickr.com)
[[../img/summary.jpg]]
